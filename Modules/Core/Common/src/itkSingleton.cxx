...
static ::itk::SingletonIndex * initializedGlobalSingletonIndex = ::itk::SingletonIndex::GetInstance();
...
public:
  ...
  static SingletonIndex * GetGlobalSingletonIndex()
    {
    if( !m_GlobalSingletonIndex )
      {
      // GetGlobalSingletonIndex() must be thread safe and can potentially call
